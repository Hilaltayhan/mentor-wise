...
Feature: Default
  ...
  Scenario : Verify that the home page loads correctly and completely.
    ...
    Then the page title should be "MentorWise - Non-Profit Dedicated to Support the Youth "
  ...
  Scenario: Verify home page links
    ...
    #Then Should be redirected to the URL "https://mentorwise.org.uk/events/"
    #When Click on the "contactUs"
    #Then Should be redirected to the URL "https://mentorwise.org.uk/contact/"